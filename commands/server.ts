...
export default class ServerCommand extends Command {
  ...
  static flags = {
    ...
    debug: {
      description: 'Run in debug mode (add the --inspect flag to node, launch node-inspector)',
      default: false,
      type: <any>'boolean'
    },
    debugBrk: {
      description: 'Run in debug mode (add the --inspect-brk flag to node, launch node-inspector)',
      default: false,
      type: <any>'boolean'
    },
    watch: {
